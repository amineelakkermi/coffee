const styles = {
    ...
    heading2: "font-poppins font-bold text-[50px] sm:text-[63px] text-[white]  xs:leading-[76.8px] leading-[66.8px] w-full",
    ...
    padding: "sm:px-16 px-6 sm:py-12 py-20",
  ...
  export const layout = {
    section: `flex md:flex-row flex-col ${styles.paddingY} min-h-screen`,
